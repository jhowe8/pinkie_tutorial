...
import 'package:pinkie_tutorial/flutter_layer/flutter_layer.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: BlocProvider<ScoreBloc>(
          ...
          child: Scaffold(
            appBar: AppBar(
                backgroundColor: Colors.black, foregroundColor: Colors.cyan),
            drawer: const MainDrawer(),
            body: Stack(children: const [FlameLayer(), FlutterLayer()]),
          ),
        ));
  }
}
